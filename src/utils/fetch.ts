  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      switch (endpoint) {
        ...
        case "transactions": //added this case to make sure all employees show up when selecting all employees again instead of being stuck on loading
          result = getTransactionsPaginated({ page: 1 }) as unknown as TData;
